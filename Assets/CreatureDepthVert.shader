...
Shader "Shader Forge/CreatureDepthVert" {
    Properties {
        ...
        _node_7359 ("node_7359", Color) = (0,0.2918229,1,1)
        _node_6627 ("node_6627", Float ) = 1
        _node_3511 ("node_3511", Float ) = 1
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float4 _node_7359;
            uniform float _node_6627;
...
////// Emissive:
                ...
                float node_6389 = (saturate((sceneZ-partZ)/_node_6627)*_node_3511);
                float3 emissive = lerp(((node_544*_Emission)+(node_544*UNITY_LIGHTMODEL_AMBIENT.rgb)),_node_7359.rgb,node_6389);
