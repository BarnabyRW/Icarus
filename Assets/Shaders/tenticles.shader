...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(_Diffuse_var.r*_Color.a));
...
////// Lighting:
                ...
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(i.uv0, _Diffuse));
                fixed4 finalRGBA = fixed4(finalColor * (_Diffuse_var.r*_Color.a),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
